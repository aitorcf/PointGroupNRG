...
# TODO 
# - Check whether hermiticity can be applied to increase speed

function matdiag_distributed_H0( 
    ...
    irrEU_new = @distributed (merge) for 
        ...
        for (m_u,m_mu,m_i) in mults,
            ...
            if hopallowed
                hblock[r_u,r_v,:] .= compute_blockelement_distributed_H0( 
                                                        m_i  , m_j , 
                                                        m_mu , m_nu ,
                                                        G , 
                                                        irrEU[G_i][1] ,
        ...
        @async begin
            ...
            irrEU_new[G] = @fetch begin
                ...
                for (m_u,m_mu,m_i) in mults,
                    ...
                    if hopallowed
                        hblock[r_u,r_v,:] .= compute_blockelement_distributed( 
                                                                m_i  , m_j , 
                                                                m_mu , m_nu ,
                                                                G , 
                                                                irrEU[G_i][1] ,
...
@inline function compute_blockelement_distributed_H0( 
            ...
            for q_a in qq_a
                ...
                @inbounds for iu::Int64 in 1:length(combs_uprima_local)    
                    ...
                    @inbounds for iv::Int64 in 1:length(combs_vprima_local)
                        ...
                        pseudo = get_pseudoCG_up_vp_distributed_H0( 
                                                    u_mu_i,
                                                    v_nu_j,
                                                    q_a,
                                                    oindex2dimensions ,
...
function get_pseudoCG_up_vp_distributed_H0( 
    ...
    @inbounds for (si_mu::Int64,s_mu::Int64) in enumerate((-S_mu):2:S_mu),
        ...
        pcgcoeff = get( pcg_atom , (q_mu,q_a,q_nu) , 0.0im )::ComplexF64
...
function compute_step_matels_distributed( 
        multiplets_block::Set{NTuple{4,Int64}}, 
        multiplets_shell::Set{NTuple{4,Int64}},
        irrEU::Dict{ NTuple{3,Int64} , Tuple{Vector{Float64},Matrix{ComplexF64}} },
        hop::Dict{ Tuple{Int64,Int64} , ComplexF64 },
    ...
    @everywhere cg_s_fullmatint = $cg_s_fullmatint
    @everywhere pcg = $pcg 
    @everywhere pcgmat = $pcgmat
    @everywhere qq_a = collect($qq_a)
    
    if method=="distfor"
    u_H1_v_blocks = @showprogress @distributed (merge) for 
                    (G,mults) in combinations_uprima_new_vec
...
@inline function compute_blockelement_distributed( 
        m_i::NTuple{4,Int64}  , m_j::NTuple{4,Int64} , 
        m_mu::NTuple{4,Int64} , m_nu::NTuple{4,Int64} , 
        G_uv::NTuple{3,Int64} ,
        E_i::Vector{Float64} ,
...
function get_pseudoCG_up_vp_distributed( 
        u_mu_i::Tuple{NTuple{6,Int64},NTuple{4,Int64},NTuple{4,Int64}} , 
        v_nu_j::Tuple{NTuple{6,Int64},NTuple{4,Int64},NTuple{4,Int64}} , 
        q_a::NTuple{6,Int64} , 
        oindex2dimensions::Vector{Int64} ,
