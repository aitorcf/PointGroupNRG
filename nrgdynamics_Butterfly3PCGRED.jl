...
normalize!( s_0_m05 )
# symstates 
symstates_m0 = Dict( (i_0...,1, 0.5,1)=>s_0_p05 ,
                     (i_0...,1,-0.5,1)=>s_0_m05 )
...
normalize!( s_1_n15 )
# symstates 
symstates_m1 = Dict( (i_1...,1, 1.5,1)=>s_1_p15 ,
                     (i_1...,1, 0.5,1)=>s_1_p05 ,
                     (i_1...,1,-0.5,1)=>s_1_n05 ,
                     (i_1...,1,-1.5,1)=>s_1_n15 )
...
normalize!( s_0p_n1 )
# symstates 
symstates_m0p = Dict( (i_0p...,1, 1.0,1)=>s_0p_p1 ,
                      (i_0p...,1, 0.0,1)=>s_0p_0 ,
...
normalize!( s_1p_0 )
# symstates 
symstates_m1p = Dict( (i_1p...,1,0.0,1)=>s_1p_0 ) 
...
s_0n_n1 = slat_2dd00
# symstates
symstates_m0n = Dict( (i_0n...,1, 1.0,1)=>s_0n_p1 ,
                      (i_0n...,1, 0.0,1)=>s_0n_0 ,
...
normalize!( s_1m_0 ) 
# symstates 
symstates_m1n = Dict( (i_1n...,1,0.0,1)=>s_1m_0 )

# all together
symstates_atom = merge( symstates_m0  , 
                        symstates_m1  ,
                        symstates_m0n ,
                        symstates_m1n ,
                        symstates_m0p ,
...
atom_creops = Dict(
    ...
    (1,"A1g",0.5,1, 0.5,3) => cre_2u,
    (1,"A1g",0.5,1,-0.5,3) => cre_2d,
